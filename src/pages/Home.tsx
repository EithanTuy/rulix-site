    ...
    <section id="sample" className="border-b border-line-soft bg-panel">
      <div className="wrap py-20">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-[260px_1fr]">
          ...
          <div className="overflow-hidden border border-line-soft bg-bg">
          ...
          {USE_CASES.map((item) => (
            <div key={item.title} className="grid gap-5 py-8 md:grid-cols-[70px_1fr] md:items-center">
              ...
              <div>
                ...
                <p className="m-0 mt-2 max-w-[64ch] text-[14.5px] text-text-2">{item.body}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <section id="lead" className="border-b border-line-soft bg-panel">
      <div className="wrap grid gap-10 py-20 lg:grid-cols-[1fr_0.7fr] lg:items-start">
        ...
        <div className="grid gap-4 pt-2">
          <a href={mailHref} className="panel flex items-center gap-4 p-5 transition-colors hover:border-accent">
